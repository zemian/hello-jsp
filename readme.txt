...
For IDE (IntelliJ), you may create a Tomcat Server and then run it with this project deploy
to run inside IDE. This setup would allow you to set breakpoint to debug.
